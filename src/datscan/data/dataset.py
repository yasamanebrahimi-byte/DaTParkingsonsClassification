...
class DaTSPECTDataset(Dataset):
    def __init__(self, frame: pd.DataFrame, config: PreprocessConfig, augment: Optional[Callable] = None) -> None:
    ...
    def __getitem__(self, index: int) -> Dict[str, object]:
        ...
        array = preprocess_nifti(str(Path(row["filepath"])), self.config)
